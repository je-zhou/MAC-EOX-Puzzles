...
export const levels: CarType[][] = [
  [
    ...
    { id: 2, x: 3, y: 2, length: 3, orientation: "vertical", isMain: false, color: "blue-500", image: "/rush-hour/longcar-v.png" },
    { id: 3, x: 5, y: 3, length: 3, orientation: "vertical", isMain: false, color: "green-500", image: "/rush-hour/longcar-v.png" },
    { id: 4, x: 1, y: 3, length: 2, orientation: "horizontal", isMain: false, color: "green-500", image: "/rush-hour/policecar-h.png" },
    { id: 5, x: 2, y: 5, length: 2, orientation: "horizontal", isMain: false, color: "green-500", image: "/rush-hour/policecar-h.png" },
    { id: 6, x: 1, y: 4, length: 2, orientation: "vertical", isMain: false, color: "green-500", image: "/rush-hour/policecar-v.png" },
  ],
  [
    // Level 1 configuration
    { id: 1, x: 1, y: 2, length: 2, orientation: "horizontal", isMain: true, color: "red-500", image: "/rush-hour/pinkcar-h.png" },
